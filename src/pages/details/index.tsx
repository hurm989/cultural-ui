...
export default function LoginScreen() {
    ...
    const [selectedValue2, setSelectedValue2] = useState<string>("male");
        ...
        <>
            <MainContainer className={styles.heading}>
                ...
                <Grid container alignItems="center" sx={{ maxWidth: "900px" }}>
                    <Grid item xs={8}>
                        <SelectCompanionHeding>{t("registerCompanion")}</SelectCompanionHeding>
                        ...
                        <Grid item xs={4} key={detail.id}>
                            ...
                            >
                                <DetailsContent>
                                    ...
                                    <Checkbox checked icon={<Circle />} checkedIcon={<Circle />} />
                                </DetailsContent>
                                <Box
                                    sx={{
                                        display: "flex",
                ...
                <Box sx={{ mt: "3rem" }}>
                    <CustomButton onClick={() => router.push("/info")}
