...
const Welcome = () => {
    ...
    return (
        <MainContainer className={styles.heading}>
            ...
            <LoginHeading sx={{ margin: "3rem 0 !important" }}>{t("RegistrationCompletedSuccessfuly")}</LoginHeading>
            <Grid container sx={{ maxWidth: "900px", mt: 3, mb: 5, px: 2 }} alignItems="center" spacing={3}>

                <Grid item xs={7}>
                    <SuccessHeading>{t("YourRegistrationCompletted")}</SuccessHeading>
                    <SuccessHeading>{t("welcometothehouse")}</SuccessHeading>
                </Grid>
                <Grid item xs={5}>
